...
content = content.replace(/storage\.sessionSet\(\{ agentState/g, 'storage.sessionSet({ [\gentState_\\]');
content = content.replace(/storage\.sessionSet\(\{ stepCount/g, 'storage.sessionSet({ [\stepCount_\\]');
