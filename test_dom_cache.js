            ...
            try {
              ...
              if (!window.__lensAgentPiiDirty && window.__lensAgentElements) {
                return window.__lensAgentElements.map(item => {
                  ...
                  return {
                    ...
                    redactionLabel: item.data.redactionLabel,
                    boundingBox: {
              ...
              allElements.forEach((el) => {
                ...
                const pushItem = (cat, type, labelBase) => {
                  const data = {
                    id: labelBase + '_' + counter,
                    type: type,
                    category: cat,
                    redactionLabel: '[REDACTED_' + cat + '_#' + counter + ']'
                  };
                  counter++;
                ...
                if (dataPii || isSensitiveClass) {
                  ...
                  pushItem(cat, 'SENSITIVE_ELEMENT', 'SENSITIVE');
                ...
                if (tag === 'input' || tag === 'textarea' || tag === 'select' || el.isContentEditable) {
                  ...
                  if (type === 'password') {
                    pushItem('PASSWORD', 'INPUT_FIELD', 'SEC_PASSWORD');
                    return;
                  }
                  ...
                  if (sensitiveKeywords.test(attrContext) || dataPii) {
                    ...
                    pushItem(matchedCat, 'INPUT_FIELD', 'SEC');
                    return;
                  }
