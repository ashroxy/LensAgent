      ...
      const res = await this._cdp("Runtime.evaluate", {
        expression: `
          (function() {
            ...
            return { page, elements: backendElements };
          })()
        `,
        returnByValue: true,
      });
      return res.result?.value || { page: {}, elements: [] };
    } catch (err) {
